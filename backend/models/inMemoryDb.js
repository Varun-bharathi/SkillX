...
// Seeding standard courses
export const inMemoryCourses = [
  {
    id: "react-core",
...
export const inMemoryQuizzes = [
  ...
  },
  {
    ...
    questions: [
      {
        id: 1,
        question: "In design systems, what term describes a named, reusable design decision (such as a color or spacing value) stored as a variable?",
        options: ["Design Token", "Style Guide", "Component Variant", "Asset Library"],
        correctAnswer: 0,
        explanation: "Design tokens are the single source of truth for design decisions. They store named values (colors, spacing, typography) that are consumed across platforms."
      },
      {
        id: 2,
        question: "Which Figma feature allows a component to have multiple configurations (e.g., size=small/large, state=default/hover) without duplicating frames?",
        options: ["Auto Layout", "Component Variants", "Prototyping Links", "Shared Libraries"],
        correctAnswer: 1,
        explanation: "Component Variants in Figma let you bundle related components into one master component group with switchable properties, reducing duplication."
      },
      {
        id: 3,
        question: "What does 'visual hierarchy' primarily determine in a UI design?",
        options: ["The order of CSS selectors in a stylesheet", "The sequence in which a user's eye is drawn across the interface", "The layering order of HTML elements in the DOM", "The priority of media queries in responsive layouts"],
        correctAnswer: 1,
        explanation: "Visual hierarchy guides the user's attention through deliberate use of size, contrast, color, and spacing, making the most important elements stand out first."
      },
      {
        id: 4,
        question: "In UX design, what is 'cognitive load' and why is reducing it important?",
        options: [
          "The number of API requests a UI makes; more requests mean more load.",
          "The total mental effort a user must exert to understand and use an interface; reducing it improves usability.",
          "The amount of data stored in the browser cache during a session.",
          "The time it takes for JavaScript to parse and execute on the main thread."
        ],
        correctAnswer: 1,
        explanation: "Cognitive load is the mental effort required to process information. Lower cognitive load leads to faster decision-making and fewer user errors."
      },
      {
        id: 5,
        question: "Which color model is most commonly used when designing for screens and digital interfaces?",
        options: ["CMYK", "Pantone", "RGB", "HSL only"],
        correctAnswer: 2,
        explanation: "RGB (Red, Green, Blue) is the standard additive color model for screens. Digital displays emit light using these three channels."
      },
      {
        id: 6,
        question: "What is the primary purpose of Figma's 'Auto Layout' feature?",
        options: ["To export assets in multiple resolutions automatically", "To create frames that dynamically resize and reposition child elements based on content", "To synchronize designs with a live coding environment", "To generate CSS code from selected frames"],
        correctAnswer: 1,
        explanation: "Auto Layout creates frames that automatically adapt their size and spacing as content changes, similar to CSS Flexbox behavior."
      },
      {
        id: 7,
        question: "In the 8-point grid system used in design, what is the standard base unit for spacing?",
        options: ["4px", "8px", "16px", "12px"],
        correctAnswer: 1,
        explanation: "The 8-point grid system uses multiples of 8px (8, 16, 24, 32...) for spacing and sizing, creating consistent visual rhythm across all screen sizes."
      },
      {
        id: 8,
        question: "What distinguishes a 'wireframe' from a 'high-fidelity prototype' in the UX design process?",
        options: [
          "Wireframes use real content; prototypes use placeholder text.",
          "Wireframes are low-detail structural layouts; high-fidelity prototypes include visual design, color, and interaction.",
          "Wireframes are coded in HTML; prototypes are built in Figma.",
          "There is no meaningful difference between them."
        ],
        correctAnswer: 1,
        explanation: "Wireframes are skeletal blueprints focusing on layout and structure. High-fidelity prototypes closely resemble the final product with full visual design and interactions."
      },
      {
        id: 9,
        question: "Which accessibility guideline standard defines the minimum contrast ratio for normal text against its background?",
        options: ["ISO 9241", "WCAG 2.1 AA (4.5:1 ratio)", "Section 508", "ADA Title III"],
        correctAnswer: 1,
        explanation: "WCAG 2.1 Level AA requires a minimum contrast ratio of 4.5:1 for normal text and 3:1 for large text to ensure readability for users with low vision."
      },
      {
        id: 10,
        question: "What is the role of a 'style guide' in a design system?",
        options: [
          "A document specifying backend API schema and endpoint contracts.",
          "A reference document that defines the visual language: colors, typography, iconography, and component usage rules.",
          "A version control system for design files.",
          "A testing checklist for QA engineers validating UI components."
        ],
        correctAnswer: 1,
        explanation: "A style guide documents the visual standards of a product — colors, fonts, spacing, and component rules — ensuring consistency across all team members and platforms."
      }
    ]
  },
  {
    ...
    questions: [
      {
        id: 1,
        question: "Which chart type is most appropriate for showing how a part relates to the whole of a dataset?",
        options: ["Line Chart", "Scatter Plot", "Pie / Donut Chart", "Box Plot"],
        correctAnswer: 2,
        explanation: "Pie and donut charts are designed to show proportional relationships between parts of a whole, where all segments sum to 100%."
      },
      {
        id: 2,
        question: "In Recharts (a React charting library), which component is responsible for wrapping all other chart elements and defining the chart's dimensions?",
        options: ["<BarChart>", "<ResponsiveContainer>", "<ChartWrapper>", "<DataProvider>"],
        correctAnswer: 1,
        explanation: "<ResponsiveContainer> in Recharts wraps chart components and makes them fluid, automatically adapting to parent container dimensions."
      },
      {
        id: 3,
        question: "What does 'data-ink ratio' mean in the context of Edward Tufte's principles of data visualization?",
        options: [
          "The number of API calls needed to fetch chart data.",
          "The proportion of ink (or pixels) used to represent actual data versus decorative or redundant elements.",
          "The ratio of SVG elements to HTML elements in a chart.",
          "The color density of a heatmap visualization."
        ],
        correctAnswer: 1,
        explanation: "Tufte's data-ink ratio principle states that non-data ink (gridlines, borders, decorations) should be minimized so that the actual data stands out clearly."
      },
      {
        id: 4,
        question: "Which SVG element is the fundamental building block for drawing custom chart lines and shapes in D3.js?",
        options: ["<rect>", "<path>", "<polygon>", "<ellipse>"],
        correctAnswer: 1,
        explanation: "The <path> element is the most powerful SVG element. D3 uses path generators to create line charts, area charts, and complex shapes using path 'd' attribute commands."
      },
      {
        id: 5,
        question: "What is the purpose of a 'tooltip' in an interactive data visualization?",
        options: [
          "To provide a download button for exporting chart data as CSV.",
          "To display detailed data values when a user hovers over or clicks on a specific data point.",
          "To add an animated loading indicator while data is fetching.",
          "To filter the dataset displayed based on a date range."
        ],
        correctAnswer: 1,
        explanation: "Tooltips are contextual pop-ups that reveal precise data values for specific data points on hover or click, without cluttering the main visualization."
      },
      {
        id: 6,
        question: "When visualizing time-series data, which chart type is most effective for showing trends over a continuous time period?",
        options: ["Bar Chart", "Radar Chart", "Line Chart", "Pie Chart"],
        correctAnswer: 2,
        explanation: "Line charts connect data points along a time axis, making trends, growth rates, and patterns over continuous time periods immediately visible."
      },
      {
        id: 7,
        question: "What is the primary advantage of using a logarithmic scale on a chart axis?",
        options: [
          "It makes all values appear equal.",
          "It helps visualize data spanning multiple orders of magnitude, where both small and large values need to be compared.",
          "It automatically normalizes data to a 0-100 range.",
          "It removes outliers from the dataset before rendering."
        ],
        correctAnswer: 1,
        explanation: "A logarithmic scale compresses large ranges, allowing meaningful comparison of data points that span many orders of magnitude (e.g., from 1 to 1,000,000)."
      },
      {
        id: 8,
        question: "In dashboard design, what is the 'above the fold' principle?",
        options: [
          "All charts must be folded/collapsed by default and expanded on click.",
          "The most critical KPIs and charts should be visible without scrolling when the dashboard first loads.",
          "Charts should use folded card components with hidden legends.",
          "Dashboard data should be paginated into multiple folds for performance."
        ],
        correctAnswer: 1,
        explanation: "'Above the fold' means placing the most important information within the initially visible viewport so users see key metrics immediately without needing to scroll."
      },
      {
        id: 9,
        question: "Which React hook is most commonly used to trigger a data refetch when a chart's filter or date range changes?",
        options: ["useRef", "useMemo", "useEffect", "useReducer"],
        correctAnswer: 2,
        explanation: "useEffect with a dependency array containing the filter values will automatically re-run the fetch logic whenever those values change, keeping the chart in sync."
      },
      {
        id: 10,
        question: "What does 'chart junk' refer to in data visualization design?",
        options: [
          "Invalid or corrupted data points that cause rendering errors.",
          "Visual elements that add complexity without conveying useful data, such as excessive gridlines, 3D effects, and decorative graphics.",
          "Outdated chart libraries that are no longer maintained.",
          "Charts that load slowly due to unoptimized data queries."
        ],
        correctAnswer: 1,
        explanation: "Chart junk (coined by Edward Tufte) refers to unnecessary visual elements — decorations, excessive gridlines, 3D effects — that obscure the data rather than clarifying it."
      }
    ]
  },
  {
    ...
    questions: [
      {
        id: 1,
        question: "What does 'crawling' mean in the context of how search engines like Google process the web?",
        options: [
          "Compressing web pages for faster delivery via CDN.",
          "Automatically discovering and downloading web pages by following links across the internet.",
          "Ranking web pages based on their relevance to a search query.",
          "Rendering JavaScript on the server before indexing."
        ],
        correctAnswer: 1,
        explanation: "Crawling is the process where search engine bots (like Googlebot) systematically browse the web by following links to discover new and updated pages."
      },
      {
        id: 2,
        question: "Which HTTP meta tag instructs search engine crawlers not to index a specific page?",
        options: ["<meta name='robots' content='nofollow'>", "<meta name='robots' content='noindex'>", "<meta name='googlebot' content='nocrawl'>", "<meta http-equiv='X-Robots' content='none'>"],
        correctAnswer: 1,
        explanation: "<meta name='robots' content='noindex'> tells search engine crawlers not to include this specific page in their search index."
      },
      {
        id: 3,
        question: "What are Core Web Vitals, and which three metrics do they currently measure?",
        options: [
          "Google's set of performance metrics measuring LCP (Largest Contentful Paint), FID (First Input Delay), and CLS (Cumulative Layout Shift).",
          "PageSpeed Insights scores measuring Time to First Byte, DNS resolution, and SSL handshake time.",
          "Lighthouse audit scores measuring Performance, Accessibility, and Best Practices.",
          "Server-side metrics measuring CPU usage, memory footprint, and database query time."
        ],
        correctAnswer: 0,
        explanation: "Core Web Vitals are Google's real-world, user-centric metrics: LCP measures loading performance, FID measures interactivity, and CLS measures visual stability."
      },
      {
        id: 4,
        question: "In SEO, what is the purpose of a 'canonical tag' (<link rel='canonical'>)?",
        options: [
          "To speed up page loading by pre-loading critical resources.",
          "To tell search engines which is the preferred (master) version of a page when duplicate or similar content exists at multiple URLs.",
          "To create a breadcrumb navigation trail for search result rich snippets.",
          "To declare the language and region of a page for international SEO."
        ],
        correctAnswer: 1,
        explanation: "A canonical tag consolidates ranking signals by pointing search engines to the definitive version of a page, preventing duplicate content penalties."
      },
      {
        id: 5,
        question: "What is structured data (Schema.org markup) primarily used for in technical SEO?",
        options: [
          "To compress JSON API responses sent between server and client.",
          "To provide search engines with explicit, machine-readable information about page content, enabling rich results in SERPs.",
          "To define the database schema for storing SEO audit logs.",
          "To speed up JavaScript execution by pre-parsing script dependencies."
        ],
        correctAnswer: 1,
        explanation: "Schema.org structured data (often via JSON-LD) tells search engines exactly what your content represents (e.g., a Product, Recipe, Event), enabling rich results like star ratings and FAQs."
      },
      {
        id: 6,
        question: "What does 'keyword cannibalization' mean in SEO?",
        options: [
          "When two competitors rank for the same keyword on the same SERP page.",
          "When multiple pages on the same website compete with each other for the same keyword, diluting ranking signals.",
          "When a keyword becomes too popular and loses its search traffic value.",
          "When a website uses the same keyword too many times on a single page (keyword stuffing)."
        ],
        correctAnswer: 1,
        explanation: "Keyword cannibalization occurs when multiple pages on your own site target the same keyword, splitting authority and confusing search engines about which page to rank."
      },
      {
        id: 7,
        question: "Which Google Search Console report helps you identify which queries users type to find your site and the pages that appear for those queries?",
        options: ["Coverage Report", "Performance Report (Search Results)", "Core Web Vitals Report", "Links Report"],
        correctAnswer: 1,
        explanation: "The Performance Report in Google Search Console shows impressions, clicks, CTR, and average position for the search queries driving traffic to your pages."
      },
      {
        id: 8,
        question: "What is the key difference between 'on-page SEO' and 'off-page SEO'?",
        options: [
          "On-page SEO refers to paid ads; off-page SEO refers to organic strategies.",
          "On-page SEO involves optimizing elements within your own website (content, meta tags, HTML); off-page SEO involves external signals like backlinks and social mentions.",
          "On-page SEO is for desktop; off-page SEO is for mobile optimization.",
          "On-page SEO is measured by Google Analytics; off-page SEO is measured by Search Console."
        ],
        correctAnswer: 1,
        explanation: "On-page SEO is everything you control on your own site (content, title tags, internal links). Off-page SEO refers to external authority signals, primarily backlinks from other domains."
      },
      {
        id: 9,
        question: "What is 'LCP' (Largest Contentful Paint) and what is Google's recommended threshold for a 'good' score?",
        options: [
          "The time for the largest image or text block to render; good = under 2.5 seconds.",
          "The delay before the first user interaction is processed; good = under 100ms.",
          "The total shift of page layout after initial load; good = under 0.1.",
          "The time to first byte from the server; good = under 600ms."
        ],
        correctAnswer: 0,
        explanation: "LCP measures how long it takes for the largest visible content element to render in the viewport. Google considers under 2.5 seconds as 'Good' for LCP."
      },
      {
        id: 10,
        question: "Why is HTTPS (SSL/TLS) important for SEO beyond just security?",
        options: [
          "HTTPS has no impact on SEO; only content quality matters.",
          "Google uses HTTPS as a confirmed ranking signal, and browsers mark HTTP sites as 'Not Secure', which increases bounce rates and hurts user trust signals.",
          "HTTPS only matters for e-commerce pages that handle payment data.",
          "HTTPS speeds up page load times by compressing all HTTP responses."
        ],
        correctAnswer: 1,
        explanation: "Google confirmed HTTPS as a ranking signal in 2014. Additionally, browsers display 'Not Secure' warnings on HTTP pages, degrading user trust and increasing bounce rates which negatively affect rankings."
      }
    ]
  }
];

// Pre-registering standard Varun Sharma profile with hashed password 'password123'
const salt = bcrypt.genSaltSync(10);
const hashedDefaultPassword = bcrypt.hashSync("password123", salt);

export const inMemoryUsers = [
  {
    _id: "user-default-varun",
    name: "Varun Sharma",
    email: "varun@aurademy.com",
