...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState("varun@aurademy.com");
      ...
      <div style={formCardStyle}>
        ...
        <div style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: "8px" }}>
          ...
          <p style={{ fontSize: "0.85rem", color: "var(--text-secondary)" }}>
            Enter your details to log in to your mock account
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: "0.8rem", marginTop: "4px" }}>
            ...
            <a 
              ...
              onClick={(e) => {
                e.preventDefault();
                alert("Reset email sent! (Mock implementation: try entering standard credentials.)");
              }}
